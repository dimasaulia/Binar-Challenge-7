...
const SearchForm = ({ searchCar }) => {
  ...
  const fillDriverForm = (data) => {
    ...
    setFormData({ ...formData, tipe: data });
    closeDriverOption();
  };
        ...
        <form className="d-flex flex-wrap align-items-end justify-content-between">
          <div className="p-2 form-item">
            ...
            <div className="input-group">
              ...
              <div
                className={`input-option bg-white ${driverOption}`}
                id="tipe_driver--option"
              >
                <p
                  className="fs-6 p-2 mb-2 input-item"
                  onClick={(e) => {
                    fillDriverForm("Dengan Sopir");
                    setFormData({ ...formData, tipe: "Dengan Sopir" });
                  }}
                >
                  Dengan Sopir
                </p>
                <p
                  className="fs-6 p-2 input-item"
                  onClick={() => fillDriverForm("Tanpa Sopir")}
                >
                  Tanpa Sopir
                </p>
              </div>
          ...
          <div className="p-2 form-item">
            ...
            <div className="input-group">
              ...
              >
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("01:00")}
                >
                  01:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("02:00")}
                >
                  02:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("03:00")}
                >
                  03:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("04:00")}
                >
                  04:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("05:00")}
                >
                  05:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("06:00")}
                >
                  06:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("07:00")}
                >
                  07:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("08:00")}
                >
                  08:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("09:00")}
                >
                  09:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("10:00")}
                >
                  10:00 WIB
                </p>
                <p
                  className="fs-6 p-2 mb-2 waktu-item"
                  onClick={() => fillPickUpForm("15:00")}
                >
                  15:00 WIB
                </p>
              </div>
